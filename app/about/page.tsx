          ...
          <div className="flex justify-center mb-12">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-sm w-full">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-primary font-medium mb-3">{teamMembers[0].role}</p>
                <p className="text-gray-600 text-sm mb-4">{teamMembers[0].description}</p>
                <div className="flex justify-center space-x-3">
                  <a href={teamMembers[0].social.linkedin} className="text-gray-400 hover:text-primary transition-colors duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                  </a>
                  <a href={teamMembers[0].social.twitter} className="text-gray-400 hover:text-primary transition-colors duration-300">
